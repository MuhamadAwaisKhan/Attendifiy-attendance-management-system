...
class EditProfilefaculty extends StatefulWidget {
  const EditProfilefaculty({Key? key}) : super(key: key);

  @override
  State<EditProfilefaculty> createState() => _EditProfilefacultyState();
}

class _EditProfilefacultyState extends State<EditProfilefaculty> {
  ...
  Future<void> _updateProfile() async {
    ...
    try {
      ...
      await _firestore.collection("faculty").doc(uid).update({
        ...
        child: Column(
          ...
          children: [
            ...
            UIHelper.customTextField(
              ...
              label: "Position",
              hintText: 'e.g: Lecturer, Associate Professor, etc.'
            ),
